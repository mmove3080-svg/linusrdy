 ...
 */
export function TrackingCard({ onTrack, loading = false, error }: TrackingCardProps) {
  ...
  return (
    <div className="card w-full max-w-xl p-3 sm:p-5">
      ...
      {error && (
        <p role="alert" className="mt-2.5 px-1 text-[12px] font-semibold text-red-600 sm:text-[13px]">
          {error}
        </p>
      )}
      ...
      <div className="mt-3 flex items-start gap-2.5 px-1 sm:mt-4 sm:gap-3">
        ...
        <p className="text-[8px] leading-snug text-ink-soft sm:text-sm sm:leading-relaxed">
