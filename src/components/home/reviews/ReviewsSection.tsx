  ...
  return (
    ...
    >
      ...
      <img
        ...
        aria-hidden="true"
        loading="lazy"
        className="pointer-events-none absolute right-0 top-14 w-[46%] max-w-[430px] animate-float-slow opacity-70 [mask-image:radial-gradient(72%_78%_at_58%_38%,black_55%,transparent)] sm:w-[36%] lg:top-16 lg:opacity-80"
      />
