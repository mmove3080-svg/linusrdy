      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4">
        {CARDS.map(({ icon: Icon, headline, lines, targetId, focusTracking }, i) => (
          <motion.article
            ...
            className="card group relative flex gap-5 p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-lift"
          >
            {/* Illustration */}
            <div className="relative flex h-24 w-24 shrink-0 items-center justify-center">
              ...
              <span
                aria-hidden="true"
                className="absolute inset-3 rounded-full border border-dashed border-brand-200 opacity-60"
              />
              <Icon className="relative h-11 w-11 text-brand-600" strokeWidth={1.5} aria-hidden="true" />
            </div>
            ...
            <div className="flex min-w-0 flex-1 flex-col">
              ...
              <span aria-hidden="true" className="mt-2 h-0.5 w-8 rounded-full bg-brand-600" />
              ...
              <button
                ...
                className="mt-auto flex h-10 w-10 items-center justify-center self-end rounded-full border border-canvas-line bg-white text-brand-600 shadow-soft transition-all duration-200 hover:bg-brand-600 hover:text-white group-hover:translate-x-0.5"
              >
