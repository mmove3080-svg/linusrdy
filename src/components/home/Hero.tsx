 ...
 */
export function Hero({ onTrack, trackingLoading, trackingError }: HeroProps) {
  return (
    <section
      id={SECTION_IDS.home}
      aria-label="Home"
      ...
      <div className="shell relative grid items-center gap-6 lg:grid-cols-[0.42fr_0.58fr] lg:gap-8">
        ...
        <div className="relative z-10">
          <motion.h1
            ...
            animate="show"
            custom={0}
            className="text-[0.9rem] font-extrabold leading-[1.2] tracking-[-0.02em] text-ink sm:text-[2rem] sm:leading-[1.12] xl:text-[2.5rem]"
          >
            Discreet Delivery.
          ...
          <motion.p
            ...
            animate="show"
            custom={1}
            className="mt-3 max-w-none text-[10px] leading-snug tracking-[-0.01em] text-ink-soft min-[400px]:whitespace-nowrap sm:mt-4 sm:max-w-md sm:text-[13px] sm:whitespace-normal lg:max-w-none xl:whitespace-nowrap"
          >
          ...
          >
            <TrackingCard onTrack={onTrack} loading={trackingLoading} error={trackingError} />
          </motion.div>
        </div>
