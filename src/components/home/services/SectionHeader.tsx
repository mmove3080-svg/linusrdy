...
export function SectionHeader() {
  return (
    ...
    >
      {/* Badge */}
      <span className="inline-flex h-8 items-center gap-2 rounded-full border border-[#E6E9FF] bg-white px-4 shadow-soft">
        <span aria-hidden="true" className="h-1.5 w-1.5 rounded-full bg-[#6C2EFF]" />
        <span className="text-[11px] font-bold tracking-[0.12em] text-ink-soft">WHAT WE DO</span>
      </span>

      {/* Heading — hero-scale, not display-scale */}
      <h2 className="mt-4 text-2xl font-extrabold leading-[1.12] tracking-[-0.02em] text-[#0F172A] sm:text-3xl xl:text-4xl">
        Six Core{" "}
      ...
      {/* Subtitle — body scale */}
      <p className="mx-auto mt-3 max-w-xl text-[13px] leading-relaxed text-ink-soft sm:text-sm">
